...
Test construct
  ...
  let __var_a = 4;;
  let __var_b = 5;;
  let rec __var_f = (fun __reserved_0 -> (if ((op_and (((same_cons __reserved_0) 2))) (((op_and (((op_and true) true))) true))) then (let __reserved_1 = (disassemble __reserved_0) in 
   (let __var_h = ((get_from_tuple __reserved_1) 0) in 
   (let __var_b0 = ((get_from_tuple __reserved_1) 1) in 
   ((op_plus __var_h) ((__var_f __var_b0)))))) else (if ((same_cons __reserved_0) 3) then (let __nothing = ((same_cons __reserved_0) 3) in 
...
Test let with let rec in
  ...
  let __var_length_tail = (let rec __var_helper = (fun __reserved_0 __reserved_1 -> (let __var_acc = __reserved_0 in 
   ...
   (if ((same_cons __reserved_2) 3) then (let __nothing = ((same_cons __reserved_2) 3) in 
   __var_acc) else (if ((op_and (((same_cons __reserved_2) 2))) (((op_and (((op_and true) true))) true))) then (let __reserved_3 = (disassemble __reserved_2) in 
...
Test let with let rec in with several capture
  ...
  let __var_f = (fun __reserved_0 -> (let __var_a = __reserved_0 in 
   ...
   (if ((same_cons __reserved_3) 3) then (let __nothing = ((same_cons __reserved_3) 3) in 
   __var_acc) else (if ((op_and (((same_cons __reserved_3) 2))) (((op_and (((op_and true) true))) true))) then (let __reserved_4 = (disassemble __reserved_3) in 

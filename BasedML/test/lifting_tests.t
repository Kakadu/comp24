  ...
  > EOF
  let  ll_0 x y  = ((( + ) x) y)
  let  test1 x  = (let  test2_arg_1 = x in (ll_0 test2_arg_1))

  $ dune exec ./lifting_demo.exe << EOF
  > let test1 (x, y) = let test2 i = (x, y, i) in test2
  > EOF
  let  ll_0 x y i  = (x, y, i)
  let  test1 (x, y)  = (let  test2_arg_2 = y in (let  test2_arg_1 = x in ((ll_0 test2_arg_1) test2_arg_2)))
  ...
  let  nested1  = (let  nested2 = 5 in (let  nested3 = 6 in (let  nested4_arg_2 = nested3 in (let  nested4_arg_1 = nested2 in (((ll_0 nested4_arg_1) nested4_arg_2) 55)))))
  ...
  let  some_name2  = 5
  let  ll_0 a1 a s  = ((( + ) a) s)
  let  test a1  = (let  some_name1 = some_name2 in (let  nested_fun_arg_1 = a1 in (((ll_0 nested_fun_arg_1) nested_fun_arg_1) 5)))

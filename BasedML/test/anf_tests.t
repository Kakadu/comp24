  ...
  > EOF
   ( = ) x_0 5 let  ll_0 unbound_a_0 x_0  = let anf_app_0 =  in
  ...
  > EOF
   x_0 5  let  ll_0 x_0  = let anf_app_0 =  in
  ...
  > EOF
   ( * ) n_0 acc_0  cont_0 anf_app_0  let  ll_0 cont_0 n_0 acc_0  = let anf_app_0 =  in
   let anf_app_1 =  in
   anf_app_1;;
  ...
  >   cont (a + b)))
  > EOF
   ( + ) a_0 b_0  cont_0 anf_app_0  let  ll_1 a_0 cont_0 b_0  = let anf_app_0 =  in
   let anf_app_1 =  in
   anf_app_1;;
  ...
  > EOF
   ( + ) 5 5  ( + ) 6 6  ( * ) 7 8 let  test_0  = let anf_app_0 =  in
   let anf_app_1 =  in
   let anf_app_2 =  in
  ...
  $ dune exec ./anf_demo.exe < ./manytests/typed/001fac.ml
   ( <= ) n_0 1 let rec fac_0 n_0  = let anf_app_0 =  in
  ...
  $ dune exec ./anf_demo.exe < ./manytests/typed/002fac.ml
   ( * ) p_0 n_0  k_0 anf_app_0  let  ll_0 k_0 n_0 p_0  = let anf_app_0 =  in
   let anf_app_1 =  in
   anf_app_1;;
  ...
  $ dune exec ./anf_demo.exe < ./manytests/typed/003fib.ml
   ( = ) n_0 1 let rec fib_acc_0 a_0 b_0 n_0  = let anf_app_0 =  in
  ...
  $ dune exec ./anf_demo.exe < ./manytests/typed/004manyargs.ml
   ( = ) 1 1 let  wrap_0 f_0  = let anf_app_0 =  in
  ...
  $ dune exec ./anf_demo.exe < ./manytests/typed/005fix.ml
   fix_0 f_0   f_0 anf_app_0 x_0 let rec fix_0 f_0 x_0  = let anf_app_0 =  in
   let anf_app_1 =  in
   anf_app_1;;
  ...
  $ dune exec ./anf_demo.exe < ./manytests/typed/006partial.ml
   ( + ) foo_1 2 let  ll_0 foo_1  = let anf_app_0 =  in
   anf_app_0;;
  ...
  $ dune exec ./anf_demo.exe < ./manytests/typed/006partial2.ml
   print_int a_0   ( = ) anf_app_0 () let  foo_0 a_0 b_0 c_0  = let anf_app_0 =  in
   let anf_app_1 =  in
  ...
  $ dune exec ./anf_demo.exe < ./manytests/typed/006partial3.ml
   print_int c_0  let  ll_1 c_0  = let anf_app_0 =  in
   anf_app_0;;
  ...
  $ dune exec ./anf_demo.exe < ./manytests/typed/008ascription.ml
   g_0 x_0  let  addi_0 f_0 g_0 x_0  = let anf_app_0 =  in
  ...
  $ dune exec ./anf_demo.exe < ./manytests/typed/009let_poly.ml
   ll_0 1   ll_0 true  let  ll_0 x_0  = x_0;;
  let  temp_0  = let anf_app_0 =  in
   let anf_app_1 =  in
  ...
  $ dune exec ./anf_demo.exe < ./manytests/typed/016lists.ml
   ( = ) xs_0 [] let rec length_0 xs_0  = let anf_app_0 =  in
  ...
  > EOF
   ( + ) a1_0 a2_0  ( + ) anf_app_0 a3_0 let  test_0 a1_0 a2_0 a3_0  = let anf_app_0 =  in
   let anf_app_1 =  in
   anf_app_1;;
  ...
  > let () = print_int (g 5) 
  > EOF
   ( + ) a_0 5 let  funct_0 a_0  = let anf_app_0 =  in
   anf_app_0;;
  ...
  >   | x -> even (x - 1)
  > EOF
   ( = ) n_0 0 let rec  even_0 n_0  = let anf_app_0 =  in
  ...
  > EOF
   f_0 x_0   ( :: ) anf_app_0 t_0 let  ll_0 f_0 k_0 x_0 t_0  = let anf_app_0 =  in
   let anf_app_1 =  in

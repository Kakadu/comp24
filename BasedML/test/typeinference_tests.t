  ...
  [""( * )"": (int -> (int -> int)),
   ...
   ""( > )"": ('_pd9 -> ('_pd9 -> bool)),
   ""( >= )"": ('_pda -> ('_pda -> bool)),
   ""append"": (('_pdb list) -> (('_pdb list) -> ('_pdb list))),
   ""cartesian"": (('_pdc list) -> (('_pdd list) -> (('_pdc * '_pdd) list))),
   ""concat"": ((('_pde list) list) -> ('_pde list)),
   ""iter"": (('_pdf -> unit) -> (('_pdf list) -> unit)),
   ""length"": (('_pe0 list) -> int),
   ""length_tail"": (('_pe1 list) -> int),
   ""main"": int,
   ""map"": (('_pe2 -> '_pe3) -> (('_pe2 list) -> ('_pe3 list))),
   ""print_int"": (int -> unit),
   ]

  ...
  let a0 fib k n a = let a4 = a1 a k in
  let a3 = ( - ) n 2 in
  fib a3 a4
  
  let rec fib n k = let a5 = ( < ) n 2 in
  if a5
  then k n
  else let a7 = a0 fib k n in
  let a6 = ( - ) n 1 in
  fib a6 a7
  
  let a2 x = x
  
  let main = let a8 = fib 6 a2 in
  print_int a8
  ...
  let a1 self a0 = let a6 = a2 a0 self in
  map a6 a0
  ...
  let tie = let a11 = (feven, fodd) in
  fixpoly a11
  
  let rec meven n = let a12 = ( = ) n 0 in
  if a12
  then 1
  else let a13 = ( - ) n 1 in
  modd a13
  and modd n = let a14 = ( = ) n 0 in
  if a14
  then 1
  else let a15 = ( - ) n 1 in
  meven a15
  
  let main = let a16 = modd 1 in
  let () = print_int a16 in
  let a17 = meven 2 in

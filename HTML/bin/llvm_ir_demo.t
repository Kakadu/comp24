  ...
  entry:
    ...
    %EVALUATED_0.l85 = load i64, ptr %EVALUATED_0.l8, align 8
    %eq = icmp eq i64 %EVALUATED_0.l85, 0
    %app_2.l18 = alloca i64, align 8
    store i1 %eq, ptr %app_2.l18, align 1
    %app_2.l186 = load i64, ptr %app_2.l18, align 8
    %ifcondition = icmp ne i64 %app_2.l186, 0
    br i1 %ifcondition, label %then_br, label %else_br
  ...
  else_br:                                          ; preds = %entry
    %created_empty_closure7 = call i64 @create_closure(i64 ptrtoint (ptr @RTE_ERROR_MATCH_FAILURE to i64), i64 1, i64 0)
    %application_result8 = call i64 @apply_args_to_closure(i64 %created_empty_closure7, i64 1, i64 0)
    %app_4.l40 = alloca i64, align 8
    store i64 %application_result8, ptr %app_4.l40, align 8
    %app_4.l409 = load i64, ptr %app_4.l40, align 8
    br label %ifcontext
  
  ifcontext:                                        ; preds = %else_br, %then_br
    %ifphi = phi i64 [ 0, %then_br ], [ %app_4.l409, %else_br ]
    %if_3.l32 = alloca i64, align 8
    store i64 %ifphi, ptr %if_3.l32, align 8
    %if_3.l3210 = load i64, ptr %if_3.l32, align 8
    %_.l0 = alloca i64, align 8
    store i64 %if_3.l3210, ptr %_.l0, align 8
    ret i64 0
  }

...
let std_lst =
  ...
  ; eqr, Scheme (VarISet.singleton (-1), type_var (-1) @-> type_var (-1) @-> tprim_bool)
  ; neq, Scheme (VarISet.singleton (-1), type_var (-1) @-> type_var (-1) @-> tprim_bool)
  ; neqr, Scheme (VarISet.singleton (-1), type_var (-1) @-> type_var (-1) @-> tprim_bool)
  ; lt, Scheme (VarISet.singleton (-1), type_var (-1) @-> type_var (-1) @-> tprim_bool)
  ; lte, Scheme (VarISet.singleton (-1), type_var (-1) @-> type_var (-1) @-> tprim_bool)
  ; gt, Scheme (VarISet.singleton (-1), type_var (-1) @-> type_var (-1) @-> tprim_bool)
  ; gte, Scheme (VarISet.singleton (-1), type_var (-1) @-> type_var (-1) @-> tprim_bool)

  ...
  let rec vosem  = (odin_plus_dva_plus 5)
  let rec tri  = odin
  ...
  let rec fac_cps num  = ((helper num) lambada1)
  ...
  let rec test3 a b c  = 0
  let rec test10 a b c d e f g h i j  = (((((((((a + b) + c) + d) + e) + f) + g) + h) + i) + j)
  ...
  let rec foo0 x  = ((foo0 true) ((foo0 false) ((foo0 true) ((foo0 false) x))))
  ...
  let rec foo a b c  = (unit a); (unit0 b); (unit1 c); (a + (b * c))
  let  foo0  = (foo 1)
  let  foo1  = (foo0 2)
  let  foo2  = (foo1 3)
  let  unit2  = (print_int foo2)
  let rec main  = unit2; 0
  ...
  let rec foo a  = (unit0 a); lambada0
  let  unit1  = (((foo 4) 8) 9)
  let rec main  = unit1; 0
  $ ./lambdalift_demo.exe < manytests/typed/007order.ml
  let  unit a b  = (print_int (a + b))
  let  unit0 __  = (print_int __)
  let rec _start () () a () b _c () d __  = ((unit a) b); (unit0 __); (((a * b) / _c) + d)
  let rec main  = (print_int (((((((((_start (print_int 1)) (print_int 2)) 3) (print_int 4)) 100) 1000) (print_int -1)) 10000) -555555))
  $ ./lambdalift_demo.exe < manytests/typed/008ascription.ml
  let rec addi f g x  = ((f x) (g x))
  let  lambada0 x b  = 
    if b
    then (x + 1)
    else (x * 2)
  ...
  let rec fixpoly l  = ((fix (lambada0 map)) l)
  let rec feven p n  = 
    let (e, o) = p
    in 
    if (n = 0)
  ...
  let rec tie  = (fixpoly (feven, fodd))

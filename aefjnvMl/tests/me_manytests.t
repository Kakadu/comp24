  ...
  $ ./me_runner.exe < manytests/typed/012fibcps.ml
  Bindings before transformations:
  val fib: int -> (int -> 'a) -> 'a
  val main: unit
  
  Bindings after transformations:
  val cc_ac0_main: unit
  val fib: int -> (int -> 'a) -> 'a
  ...
  let rec fib n k =
    ...
    then
      ...
      (fib ((( - ) n) 1)) (((fun cc0_n cc1_k a -> (fib ((( - ) cc0_n) 2)) (((fun cc2_k cc3_a b -> cc2_k ((( + ) cc3_a) b)) cc1_k) a)) n) k))
  ;;
  
  let cc_ac0_main = print_int ((fib 6) (fun x -> x))
  ;;

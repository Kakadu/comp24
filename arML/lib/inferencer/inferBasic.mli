...
val infer_const : Ast.constant -> TypeTree.typ
...
val infer_id : TypeEnv.t -> string -> ((Substitution.t * TypeTree.typ), TypeErrors.error) Common.StateResultMonad.t

(** Recursively translates a type defenition from the AST into a type representation. *)
val get_type_by_defenition : Ast.type_defenition -> (TypeTree.typ, TypeErrors.error) Common.StateResultMonad.t

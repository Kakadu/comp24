...
and pmf_expression =
  ...
  | PMFApplication of pmf_expression * pmf_expression * pmf_expression list (** Application: f x *)
  ...
  | PMFTuple of pmf_expression * pmf_expression * pmf_expression list (** Tuple: '(E1, E2, ..., En)' *)
  | PMFListConstructor of pmf_expression * pmf_expression (** List construction: 1 :: 2 :: [] *)
  | PMFEmptyList (** Empty list: '[]' *)
  | PMFTyped of pmf_expression * type_definition (** Assigning a type to an expression: (expr : int) *)
...
type pmf_decl =
  | PMFDOrdinary of pmf_decl_case
  (** Top-level let-binding: 'let f x = x  *)

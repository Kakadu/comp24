...
let rec anf_to_program anf_program =
  List.map anf_decl_to_decl anf_program
...
and anf_expr_to_expr = function
  ...
  | AComplex complex_expr ->
    complex_expr_to_expr complex_expr

and complex_expr_to_expr = function
  | CAtom immut_expr ->
    immut_expr_to_expr immut_expr

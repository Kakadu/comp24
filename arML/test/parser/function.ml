        ...
        (EFun (((PVar (Id "x")), []),
           (ELetIn (
              ...
              (ELetIn (
                 ((PVar (Id "z")),
                  (EApplication ((EIdentifier (Id "( * )")),
                     (EIdentifier (Id "y")), [(EConstant (CInt 2))]))),
                 [], (EIdentifier (Id "z"))))
              ))
           )))
      ] |}]
           ...
           (ELetIn (
              ((PVar (Id "y")),
               (ELetIn (
                  ...
                  [],
                  (EApplication ((EIdentifier (Id "( * )")),
                     (EIdentifier (Id "z")), [(EConstant (CInt 2))]))
                  ))),
              [], (EIdentifier (Id "y"))))
           )))
      ] |}]
        ...
        (ELetIn (((PVar (Id "x")), (EConstant (CInt 3))), [],
           (ELetIn (
              ...
              (ELetIn (
                 ((PVar (Id "z")),
                  (EApplication ((EIdentifier (Id "( * )")),
                     (EIdentifier (Id "y")), [(EIdentifier (Id "x"))]))),
                 [],
                 (EApplication ((EIdentifier (Id "( - )")),
                    (EIdentifier (Id "z")), [(EIdentifier (Id "y"))]))
                 ))
              ))
           )))
      ] |}]
    ...
    [(SDeclaration
        (DOrdinary (
           ((PVar (Id "f")),
            (EFun (
               ((PTuple ((PVar (Id "x")), (PVar (Id "y")), [])),
                [(PListConstructor ((PVar (Id "w")), (PVar (Id "u"))));
                  (PVar (Id "k"))]),
               (EApplication ((EIdentifier (Id "( + )")),
                  (EApplication ((EIdentifier (Id "( + )")),
                     (EApplication ((EIdentifier (Id "( + )")),
        ...
        (DRecursive (
           ((PVar (Id "f")),
            (EFun (((PVar (Id "x")), []),
               (EIfThenElse (
                  (EApplication ((EIdentifier (Id "( = )")),
                     (EIdentifier (Id "x")), [(EConstant (CInt 0))])),
                  (EConstant (CInt 1)),
                  (Some (EApplication ((EIdentifier (Id "( * )")),
                           (EIdentifier (Id "x")),
  ...
  [%expect {|
    [(SExpression
        (ERecLetIn (
           ((PVar (Id "sum")),
            (EFun (((PVar (Id "lst")), []),
               (EMatchWith ((EIdentifier (Id "lst")),
                  (PNill, (EConstant (CInt 0))),
                  [((PListConstructor ((PVar (Id "x")), (PVar (Id "xs")))),
                    (EApplication ((EIdentifier (Id "( + )")),
                       (EIdentifier (Id "x")),
            ...
            (EFun (((PVar (Id "lst1")), [(PVar (Id "lst2"))]),
               (EMatchWith (
                  (ETuple ((EIdentifier (Id "lst1")), (EIdentifier (Id "lst2")),
                     [])),
                  ((PTuple (PNill, (PVar (Id "lst")), [])),
                   (EIdentifier (Id "lst"))),
                  [((PTuple ((PVar (Id "lst")), PNill, [])),
                    (EIdentifier (Id "lst")));
                    ((PTuple (
                        (PListConstructor ((PVar (Id "x")), (PVar (Id "xs")))),

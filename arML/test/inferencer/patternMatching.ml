...
let%expect_test _ =
  ...
  |};
  [%expect
    {| Type error: unification failed - type 'a * 'b does not match expected type 'a * 'b * 'c |}]
;;
...
let%expect_test _ =
  ...
  |};
  [%expect
    {| Type error: unification failed - type 'a * 'b does not match expected type 'a * 'b * 'c list |}]
;;

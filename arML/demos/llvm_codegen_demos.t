  ...
  $ ./start_llvm_codegen_demos.exe < manytests/typed/001fac.ml > ../lib/runtime/bin/arml.ll ; echo "RESULT:" ; clang -Wno-override-module -lffi ../lib/runtime/bin/arml.ll ../lib/runtime/bin/runtime.o -o a.out; ./a.out
  RESULT:
  1

  $ ./start_llvm_codegen_demos.exe < manytests/typed/002fac.ml > ../lib/runtime/bin/arml.ll ; echo "RESULT:" ; clang -Wno-override-module -lffi ../lib/runtime/bin/arml.ll ../lib/runtime/bin/runtime.o -o a.out; ./a.out
  RESULT:
  1

  $ ./start_llvm_codegen_demos.exe < manytests/typed/003fib.ml > ../lib/runtime/bin/arml.ll ; echo "RESULT:" ; clang -Wno-override-module -lffi ../lib/runtime/bin/arml.ll ../lib/runtime/bin/runtime.o -o a.out; ./a.out
  RESULT:
  1
  4

  $ ./start_llvm_codegen_demos.exe < manytests/typed/004manyargs.ml > ../lib/runtime/bin/arml.ll ; echo "RESULT:" ; clang -Wno-override-module -lffi ../lib/runtime/bin/arml.ll ../lib/runtime/bin/runtime.o -o a.out; ./a.out
  RESULT:
  1111111111
  1
  10
  ...
  $ ./start_llvm_codegen_demos.exe < manytests/typed/005fix.ml > ../lib/runtime/bin/arml.ll ; echo "RESULT:" ; clang -Wno-override-module -lffi ../lib/runtime/bin/arml.ll ../lib/runtime/bin/runtime.o -o a.out; ./a.out
  RESULT:
  1

  $ ./start_llvm_codegen_demos.exe < manytests/typed/006partial.ml > ../lib/runtime/bin/arml.ll ; echo "RESULT:" ; clang -Wno-override-module -lffi ../lib/runtime/bin/arml.ll ../lib/runtime/bin/runtime.o -o a.out; ./a.out
  RESULT:
  19

  $ ./start_llvm_codegen_demos.exe < manytests/typed/006partial2.ml > ../lib/runtime/bin/arml.ll ; echo "RESULT:" ; clang -Wno-override-module -lffi ../lib/runtime/bin/arml.ll ../lib/runtime/bin/runtime.o -o a.out; ./a.out
  RESULT:
  1
  2
  3
  ...
  $ ./start_llvm_codegen_demos.exe < manytests/typed/006partial3.ml > ../lib/runtime/bin/arml.ll ; echo "RESULT:" ; clang -Wno-override-module -lffi ../lib/runtime/bin/arml.ll ../lib/runtime/bin/runtime.o -o a.out; ./a.out
  RESULT:
  4
  8
  9

  $ ./start_llvm_codegen_demos.exe < manytests/typed/007order.ml > ../lib/runtime/bin/arml.ll ; echo "RESULT:" ; clang -Wno-override-module -lffi ../lib/runtime/bin/arml.ll ../lib/runtime/bin/runtime.o -o a.out; ./a.out
  RESULT:
  1
  2
  4
  ...
  $ ./start_llvm_codegen_demos.exe < manytests/typed/008ascription.ml > ../lib/runtime/bin/arml.ll ; echo "RESULT:" ; clang -Wno-override-module -lffi ../lib/runtime/bin/arml.ll ../lib/runtime/bin/runtime.o -o a.out; ./a.out
  RESULT:
  5

  $ ./start_llvm_codegen_demos.exe < manytests/typed/012fibcps.ml > ../lib/runtime/bin/arml.ll ; echo "RESULT:" ; clang -Wno-override-module -lffi ../lib/runtime/bin/arml.ll ../lib/runtime/bin/runtime.o -o a.out; ./a.out
  RESULT:
  6

...
let rec pp_ll_expr expr =
  ...
  | LIf (e1, e2, e3) ->    concat "" ["if ("; pp_ll_expr e1; ") then ("; pp_ll_expr e2; ") else ("; pp_ll_expr e3; ")"]
  | LApp (e, args) ->      concat "" ["("; e; " "; concat " " (List.map pp_ll_expr args); ")"]
;;
let pp_gl_expr = function
  | LFun (id, args, e) ->   concat "" ["(fun "; id; "("; concat " " args; ")->("; pp_ll_expr e; "))"]
;;

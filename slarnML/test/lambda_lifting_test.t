  ...
  (fun anon$2(x)->(x))
  (fun fac(n)->(let fack = (if ((n<=1)) then ((f 1)) else ((fack (n-1) (anon$1 (n ) (f )))) in (fack (n ) (anon$2 )))))
  $ dune exec lambda_lifting_test << EOF
  > let fac n = 
  ...
  (fun b(b)->((print_int (b ))))
  (fun c(c)->((print_int (c ))))
  (fun test3(a b c)->(let a = ((print_int (a )) in let b = ((print_int (b )) in let c = ((print_int (c )) in 0)))))
  (fun test10(a b c d e f g h i j)->(((((((((((a )+(b ))+(c ))+(d ))+(e ))+(f ))+(g ))+(h ))+(i ))+(j ))))
  (fun temp0()->((wrap (test10 ) 1 10 100 1000 10000 100000 1000000 10000000 100000000 1000000000)))
  (fun temp1(temp0)->((print_int (temp0 ))))
  (fun temp2()->((wrap (test3 ) 1 10 100)))
  (fun main()->(let temp0 = ((wrap (test10 ) 1 10 100 1000 10000 100000 1000000 10000000 100000000 1000000000) in let temp1 = ((print_int (temp0 )) in let temp2 = ((wrap (test3 ) 1 10 100) in 0)))))
  ...
  (fun anon$1(foo)->((foo+2)))
  (fun anon$2(foo)->((foo*10)))
  ...
  (fun main()->(let foo = ((foo 1) in let foo = ((foo (foo ) 2) in let foo = ((foo (foo ) 3) in let () = ((print_int (foo )) in 0))))))

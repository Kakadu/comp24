  ...
  (let test3 a b c=(let ()=(print_int a) in (let ()=(print_int b) in (let ()=(print_int c) in 0))))
  (let test10 a b c d e f g h i j=(((((((((a+b)+c)+d)+e)+f)+g)+h)+i)+j))
  (let main=(let rez=(test10 1 10 100 1000 10000 100000 1000000 10000000 100000000 1000000000) in (let ()=(print_int rez) in (let ()=(test3 1 10 100) in 0))))

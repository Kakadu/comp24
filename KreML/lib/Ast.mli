...
type pattern =
  | Pat_const of const
  (** [Pat_const] corresponds to putting in constant values in pattern matching, e.g. {[match n with 0 -> ...]} *)
  | Pat_var of ident
...
type expr =
  ...
  (** [Expr_fun corresponds to anonymous function. {[Expr_fun(p, body)]} represents the {[fun p -> body]} *)
